					...
					success: function(data) {
						...
						for (i = 0; i < data.length; i++) {
							html += '<tr id="' + data[i].id_tamu + '">' +
								...
								'<td>' + data[i].jumlah + '</td>' +
								'<td>' +
								'<button class="btn btn-xs btn-success" style="padding-left: 10px;padding-right: 10px;" data-toggle="modal" data-target="#form-detail" id="btn-edit" data-id="' + data[i].id_tamu + '" data-waktu="' + data[i].waktu + '" data-nik="' + data[i].nik + '" data-nama="' + data[i].nama + '" data-jk="' + data[i].jenis_kelamin + '" data-alamat="' + data[i].alamat + '" data-tujuan="' + data[i].tujuan + '" data-keperluan="' + data[i].keperluan + '" data-jumlah="' + data[i].jumlah + '" data-image="' + data[i].foto + '" > Detail</button> ' +
								'</td>' +
								'</tr>'
							no++;
						}
