...
<body>
						...
						<div class="panel panel-default card-view panel-refresh">
							...
							<div class="panel-heading">
								<div class="row">
									...
									<form id="bulan" action="Pdfberanda" method="POST">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form id="tambah">
						...
						<input type="text" class="form-control datepicker" name="input_waktu" id="waktu">
						<div class="form-group">
							<label class="control-label mb-10" for="nik">NIK</label>
							<input type="text" class="form-control" name="input_nik" id="nik" placeholder="Masukkan NIK">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<select class="form-control" name="input_tujuan" id="tujuan">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="input_keperluan" id="keperluan" placeholder="Masukkan Keperluan">
						</div>
						<div class="form-group">
							<label class="control-label mb-10" for="jumlah">Jumlah Tamu</label>
							<input type="text" class="form-control" name="input_jumlah" id="jumlah" placeholder="Masukkan Jumlah Tamu">
						</div>
						<div class="form-group">
							<label class="control-label mb-10" for="tamu">Tamu</label>
							<select class="form-control" name="input_tamu" id="tamu">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form>
						...
						<div class="form-group">
							<label class="control-label mb-10" for="tamu">Tamu</label>
							<select class="form-control" name="edit_tamu" id="edit_tamu">
								<option value="Entry">Entry</option>
								<option value="Done">Done</option>
							</select>
						</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form>
						...
						<div class="form-group">
							<label class="control-label mb-10" for="tamu">Tamu</label>
							<input type="text" class="form-control" name="detail_tamu" id="detail_tamu" disabled>
						</div>
						<div class="modal-footer">
						</div>
					</form>
	...
	<!-- <script src="./assets/dist/js/snap.js"></script> -->
	...
	<script type="text/javascript">
		$('#tambah').on('submit', function(event) {
			...
			var tamu = $('#tamu').find(":selected").text();
			...
			if (nama != "", nik != "") {
				$.ajax({
					url: "<?php echo site_url("Beranda/save"); ?>",
					type: "POST",
					data: {
						type: 1,
						nik: nik,
					...
					success: function(data) {
						...
						for (i = 0; i < data.length; i++) {
							html += '<tr id="' + data[i].id_tamu + '">' +
								...
								'<td>' + data[i].tamu + '</td>' +
								'<td>' +
								'<button class="btn btn-xs btn-success" style="padding-left: 10px;padding-right: 10px;" data-toggle="modal" data-target="#form-detail" id="btn-edit" data-id="' + data[i].id_tamu + '" data-waktu="' + data[i].waktu + '" data-nik="' + data[i].nik + '" data-nama="' + data[i].nama + '" data-jk="' + data[i].jenis_kelamin + '" data-alamat="' + data[i].alamat + '" data-tujuan="' + data[i].tujuan + '" data-keperluan="' + data[i].keperluan + '" data-jumlah="' + data[i].jumlah + '" data-image="' + data[i].foto + '" data-tamu="' + data[i].tamu + '" > Detail</button> ' +
								'<button class="btn btn-xs btn-primary" style="padding-left: 10px;padding-right: 10px;" data-toggle="modal" data-target="#form-edit" id="btn-edit" data-id="' + data[i].id_tamu + '" data-waktu="' + data[i].waktu + '" data-nik="' + data[i].nik + '" data-nama="' + data[i].nama + '" data-jk="' + data[i].jenis_kelamin + '" data-alamat="' + data[i].alamat + '" data-tujuan="' + data[i].tujuan + '" data-keperluan="' + data[i].keperluan + '" data-jumlah="' + data[i].jumlah + '" data-tamu="' + data[i].tamu + '"> <i class="fa fa-pencil"></i></button> ' +
